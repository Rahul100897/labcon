  ...
  var buildHTML = function(data){
    ...
    data.variants.forEach(function(variant) {
      ...
      if(option1_Variants_Array.indexOf(variant.option1) === -1){
        ...
        option1_Variants += '<li class="swatch-on-grid _'+handleOption1+activeVariantFirstOption1+'" title="'+escape(variant.option1)+'" data-available="'+variant.available+'" data-maybe-hide="'+maybeHide1+'">';
      ...
      if(option2_Name !== null && option2_Variants_Array.indexOf(variant.option2) === -1 && option_Variants_Array_Visible.indexOf(variant.option2) !== -1){
        ...
        option2_Variants += '<li class="swatch-on-grid _'+handleOption2+activeVariantFirstOption2+'" title="'+(variant.option2)+'" data-available="'+variant.available+'" data-maybe-hide="'+maybeHide2+'">';
      ...
      if(option3_Name !== null && option3_Variants_Array.indexOf(variant.option3) === -1 && option_Variants_Array_Visible.indexOf(variant.option3) !== -1){
        ...
        option3_Variants += '<li class="swatch-on-grid _'+handleOption3+activeVariantFirstOption3+'" title="'+escape(variant.option3)+'" data-available="'+variant.available+'" data-maybe-hide="'+maybeHide3+'">';
